...
def formulario():
    if request.method == 'POST':
        ...
        cur.execute("INSERT INTO datos (nombre,correo,apellido,mensaje,pais,telefono,edad) VALUES (%s, %s, %s, %s, %s, %s, %s)",(nombre, correo, apellido, mensaje, pais, telefono, edad))
